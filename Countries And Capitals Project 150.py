...
btn = Button(root, text="Display Country And City Name" , command = country_city_list)
...
btn2 = Button(root, text="Display Country And City Name Randomly" , command = random_country_city)
